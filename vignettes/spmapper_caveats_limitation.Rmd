...
### *Visual gaps in mapped prey consumption may indicate extremely low, but non-zero prey consumption.*
*spmapplot*() includes a lower limit to the colour scale for visualisation purposes. Note that in some instances this may produce visual gaps in the prey consumption maps where very low quantities of prey consumption are estimated. Users can extract consumption map object/s from *spmapper*() outputs (see methods) and plot them separately if desired. This concerns map visualisation only, not spatial extractions results.
...
Wakefield, E. D., Owen, E., Baer, J., Carroll, M. J., Daunt, F., Dodd, S. G., Green, J. A., Guilford, T., Mavor, R. A., Miller, P. I., Newell, M. A., Newton, S. F., Robertson, G. S., Shoji, A., Soanes, L. M., Votier, S. C., Wanless, S. and Bolton, M. (2017) “Breeding density, fine-scale tracking, and large-scale modeling reveal the regional distribution of four seabird species.,” *Ecological Applications*, 27(7), pp. 2074–2091. https://doi.org/10.1002/eap.1591.
