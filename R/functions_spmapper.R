...
spmapper <- function(spname, fppolys, popscen, tooldir){
  ...
  file_energypars_est <- file.path(tooldir, "Data", "Seabird_energetics_pars_spmapper.csv")
  ...
  file_udmap <- file.path(tooldir, "Data", paste0("FAME_UD_standardised_", spcode, ".tif"))
